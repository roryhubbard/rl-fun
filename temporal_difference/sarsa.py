...
def sarsa(env, num_episodes, discount_rate=1.0, alpha=0.5, epsilon=0.1):
    """
...
def main():
    ...
    ax[0].set_title('SARSA Training Episode Rewards')
    ax[0].set_xlabel('episode number')
    ax[0].set_ylabel('episode reward sum')
    ax[1].set_title('SARSA Training Episode Lengths')
